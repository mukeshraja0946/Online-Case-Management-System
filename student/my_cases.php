...
<head>
    ...
    <title>My Submissions - OCMS</title>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="my_cases.php" class="menu-item active"><i class="fas fa-file-alt"></i> My Submissions</a>
        ...
        <div class="main_content">
            <div class="topbar">
                <div class="search-bar"><i class="fas fa-search"></i><input type="text" id="dashboard-search" placeholder="Search submissions..."></div>
                <div class="user-nav">
            ...
            <div class="container mt-2">
                <h4 class="mb-4 fw-bold">My Case Submissions</h4>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                <thead class="bg-light">
                                    <tr class="text-center">
                                        ...
                                        <th class="py-3">Reason / Explanation</th>
                                    ...
                                    <?php if ($result->num_rows > 0): ?>
                                        <?php while($row = $result->fetch_assoc()): ?>
                                            <tr class="text-center">
                                                ...
                                                <td title="<?php echo htmlspecialchars($row['reason']); ?>">
                                                    <div style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin: 0 auto;">
                                                ...
                                                <td>
                                                    <?php if ($row['file']): ?>
                                                        <a href="../uploads/<?php echo $row['file']; ?>" target="_blank" class="text-primary"><i class="fas fa-file-alt"></i> View</a>
                                                    <?php else: ?>
                                                        <span class="text-muted">-</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="small italic text-muted"><?php echo htmlspecialchars($row['staff_remark'] ?? 'Waiting for review'); ?></td>
                                                <td>
                                        ...
                                        <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr><td colspan="7" class="text-center py-5 text-muted">No submissions found. <a href="available_cases.php">Browse cases to respond.</a></td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
