...
// Fetch student rejected submissions
$sql = "SELECT s.*, c.title as case_title 
        FROM case_submissions s 
        JOIN cases c ON s.case_id = c.id 
        WHERE s.student_id = ? AND s.status = 'Rejected' 
    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="rejected_cases.php" class="menu-item active"><i class="fas fa-times-circle"></i> Rejected Submissions</a>
        ...
        <div class="main_content">
            ...
            <div class="container mt-2">
                <h4 class="mb-4 fw-bold">Rejected Case Submissions</h4>
                <div class="card shadow-sm border-0" style="border-radius: 12px; border-top: 5px solid #ef4444;">
                                    ...
                                    <?php if ($result->num_rows > 0): ?>
                                        <?php while($row = $result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td class="small text-danger fw-bold"><?php echo htmlspecialchars($row['staff_remark'] ?? 'Rejected without remark'); ?></td>
                                                <td><span class="status-badge status-Rejected">Rejected</span></td>
                                            </tr>
                                        <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr><td colspan="4" class="text-center py-5 text-muted">No rejected submissions found.</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
