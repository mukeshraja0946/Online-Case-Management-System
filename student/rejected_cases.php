...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $del_stmt = $conn->prepare("UPDATE cases SET student_rejected_visible = 0 WHERE id = ? AND student_id = ?");
...
$sql = "SELECT * FROM cases WHERE student_id = ? AND status = 'Rejected' AND student_rejected_visible = 1 ORDER BY created_at DESC";
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="rejected_cases.php" class="active"><i class="fas fa-times-circle"></i> Rejected Cases</a>
        ...
        <div class="main_content">
            ...
            <div class="container mt-5">
                <h4 class="mb-4">Rejected Cases</h4>
