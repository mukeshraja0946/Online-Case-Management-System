...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $del_stmt = $conn->prepare("UPDATE cases SET student_approved_visible = 0 WHERE id = ? AND student_id = ?");
...
$sql = "SELECT * FROM cases WHERE student_id = ? AND status = 'Approved' AND student_approved_visible = 1 ORDER BY created_at DESC";
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="approved_cases.php" class="active"><i class="fas fa-check-circle"></i> Approved Cases</a>
        ...
        <div class="main_content">
            ...
            <div class="topbar">
                <div class="search-bar">
                    ...
                    <input type="text" id="dashboard-search" placeholder="Search approved cases...">
                </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php if ($result->num_rows > 0): ?>
                                        ...
                                        <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr><td colspan="10" class="text-center">No approved cases found.</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
