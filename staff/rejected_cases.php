...
<head>
    ...
    <title>Rejected Submissions - OCMS</title>
    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="rejected_cases.php" class="menu-item active"><i class="fas fa-times-circle"></i> Rejected</a>
        ...
        <div class="main_content">
            <div class="topbar">
                <div class="search-bar"><i class="fas fa-search"></i><input type="text" placeholder="Search rejected..."></div>
                <div class="user-nav">
            ...
            <div class="container-fluid py-4 px-4">
                <h4 class="fw-bold mb-4">Rejected Student Responses</h4>
                            ...
                            <table class="table table-hover align-middle mb-0 text-center">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th class="py-3">Explanation</th>
                                        <th class="py-3">Processed At</th>
                                        <th class="py-3">Reason for Rejection</th>
                                    ...
                                    <?php if ($result->num_rows > 0): ?>
                                        <?php while($row = $result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td title="<?php echo htmlspecialchars($row['reason']); ?>"><?php echo htmlspecialchars(substr($row['reason'], 0, 30)) . (strlen($row['reason']) > 30 ? '...' : ''); ?></td>
                                                <td><?php echo date('M d, Y', strtotime($row['submitted_at'])); ?></td>
                                                <td class="small text-danger fw-bold"><?php echo htmlspecialchars($row['staff_remark'] ?? 'No remark provided'); ?></td>
                                                <td><span class="badge bg-danger">Rejected</span></td>
                                            </tr>
                                        <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr><td colspan="6" class="text-center py-5 text-muted">No rejected responses found.</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
