...
$sql_stats = "SELECT 
    ...
    SUM(CASE WHEN status = 'Approved' AND staff_approved_visible = 1 THEN 1 ELSE 0 END) as approved,
    SUM(CASE WHEN status = 'Rejected' AND staff_rejected_visible = 1 THEN 1 ELSE 0 END) as rejected
FROM cases WHERE deleted_by_staff = 0 AND deleted_by_student = 0";

$result = $conn->query($sql_stats);
$stats = $result->fetch_assoc();

// Fetch Latest Pending Cases
$sql_pending = "SELECT * FROM cases WHERE status = 'Pending' AND deleted_by_staff = 0 AND deleted_by_student = 0 ORDER BY created_at ASC LIMIT 5";
            ...
            <div class="topbar">
                ...
                <div class="user-nav">
                    ...
                    <div class="user-profile">
                        <div class="avatar" style="background: var(--secondary-color);"><?php echo strtoupper(substr($staff_name, 0, 1)); ?></div>
