    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="approved_cases.php" class="menu-item active"><i class="fas fa-check-circle"></i> Approved</a>
        ...
        <div class="main_content">
            <div class="topbar">
                <div class="search-bar"><i class="fas fa-search"></i><input type="text" placeholder="Search approved..."></div>
                <div class="user-nav">
            ...
            <div class="container-fluid py-4 px-4">
                <h4 class="fw-bold mb-4">Approved Student Responses</h4>
                                    ...
                                    <?php if ($result->num_rows > 0): ?>
                                        <?php while($row = $result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td class="small text-success"><?php echo htmlspecialchars($row['staff_remark'] ?? '-'); ?></td>
                                                <td><span class="badge bg-success">Approved</span></td>
                                            </tr>
                                        <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr><td colspan="6" class="text-center py-5 text-muted">No approved responses yet.</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
