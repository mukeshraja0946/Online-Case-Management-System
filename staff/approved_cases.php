...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $del_stmt = $conn->prepare("UPDATE cases SET staff_approved_visible = 0 WHERE id = ?");
...
$sql = "SELECT * FROM cases WHERE status = 'Approved' AND deleted_by_staff = 0 AND deleted_by_student = 0 AND staff_approved_visible = 1 ORDER BY created_at DESC";
